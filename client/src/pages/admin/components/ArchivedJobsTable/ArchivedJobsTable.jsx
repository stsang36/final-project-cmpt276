...
import { useGetAllInactiveJobsQuery, useDeleteJobMutation } from 'redux/slices/jobSlice'
...
const ArchivedJobsTable = () => {
  const location = useLocation()
  const {data} = useGetAllInactiveJobsQuery()
...
export default ArchivedJobsTable